...
import com.wisii.wisedoc.fonts.FontType;
import com.wisii.wisedoc.fonts.Typeface;


/**
 * This class implements com.wisii.wisedoc.layout.FontMetrics and
...
//    private static Java2DFontMetrics metric = null;
    ...
    /**
     * @see com.wisii.wisedoc.fonts.FontMetrics#getFontName()
     */
    ...
    /**
     * @see com.wisii.wisedoc.fonts.FontMetrics#getStyle()
     */
    public int getStyle() {
        return style;
    }
    ...
    /**
     * @see com.wisii.wisedoc.fonts.FontMetrics#getFontType()
     */
    ...
    /**
     * @see com.wisii.wisedoc.fonts.FontMetrics#getMaxAscent(int)
     */
    ...
    /**
     * @see com.wisii.wisedoc.fonts.FontMetrics#getAscender(int)
     */
    ...
    /**
     * @see com.wisii.wisedoc.fonts.FontMetrics#getCapHeight(int)
     */
    ...
    /**
     * @see com.wisii.wisedoc.fonts.FontMetrics#getDescender(int)
     */
    ...
    /**
     * @see com.wisii.wisedoc.fonts.FontMetrics#getXHeight(int)
     */
    ...
    /**
     * @see com.wisii.wisedoc.fonts.FontMetrics#getWidth(int, int)
     */
    ...
    /**
     * @see com.wisii.wisedoc.fonts.FontMetrics#getWidths()
     */
    ...
    /**
     * @see com.wisii.wisedoc.fonts.FontMetrics#getKerningInfo()
     */
    ...
    /**
     * @see com.wisii.wisedoc.fonts.FontMetrics#hasKerningInfo()
     */
    public boolean hasKerningInfo() {
        return false;
    }

    /** @see com.wisii.wisedoc.fonts.Typeface#getEncoding() */
    public String getEncoding() {
        return null; //Not applicable to Java2D rendering
    }

    /** @see com.wisii.wisedoc.fonts.Typeface#mapChar(char) */
    public char mapChar(char c) {
        return c;
    }

    /** @see com.wisii.wisedoc.fonts.Typeface#hasChar(char) */
