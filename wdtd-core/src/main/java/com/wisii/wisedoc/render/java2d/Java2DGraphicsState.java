...
public class Java2DGraphicsState {
     ...
     */
    public Java2DGraphicsState(final Graphics2D graphics, final FontInfo fontInfo,
    ...
    public boolean updateFont(final String name, final int size) {
        ...
        final FontMetricsMapper mapper = (FontMetricsMapper)fontInfo.getMetricsFor(name);
        ...
        final boolean updateStyle = (mapper.getStyle() != getGraph().getFont().getStyle()); // add by huangzl.因为style变化，但getGraph().getFont().getStyle()的返回值可能不变。
	...
	public String toString() {
        final String s = "AWTGraphicsState " + currentGraphics.toString()
