...
public class Java2DFontMetrics {
     ...
     */
    public Java2DFontMetrics(final Graphics2D graphics) {
     ...
     */
    public int getMaxAscent(final String family, final int style, final int size) {
     ...
     * @return ascent in milliponts
     */
    public int getAscender(final String family, final int style, final int size) {
        setFont(family, style, size);
     ...
     */
    public int getCapHeight(final String family, final int style, final int size) {
     ...
     */
    public int getDescender(final String family, final int style, final int size) {
        setFont(family, style, size);
     ...
     */
    public int getXHeight(final String family, final int style, final int size) {
        setFont(family, style, size);
        return xHeight * 1000;
    }
     ...
     */
    public int width(final int i, final String family, final int style, final int size) {
        int w;
        setFont(family, style, size);
    ...
    private int internalCharWidth(final int i) {
        //w = (int)(fmt.charWidth(i) * 1000); //Not accurate enough!
        final char[] ch = {(char)i};
        final Rectangle2D rect = fmt.getStringBounds(ch, 0, 1, this.graphics);
     ...
     */
    public int[] getWidths(final String family, final int style, final int size) {
        int i;
    ...
    private  Font getBaseFont(final String family, final int style, final float size) {
     ...
     */
    private boolean setFont(final String family, final int style, final int size) {
        boolean changed = false;
        final float s = size / 1000f;
        ...
        if (changed) {
            ...
            //没用到，暂时注掉
//          LineMetrics lm = f1.getLineMetrics("x", graphics.getFontRenderContext());
            ...
            /* 【删除：START】by 李晓光2008-12-3 */
            /*ascender = (int)Math.round(-rect.getY() * 1000);*/
            /* 【删除：END】by 李晓光2008-12-3 */
            /* 【添加：START】by 李晓光2008-12-3 */
            ascender = Math.round(layout.getAscent() * 1000);
            /* 【添加：END】by 李晓光2008-12-3 */
     ...
     */
    public java.awt.Font getFont(final String family, final int style, final int size) {
        setFont(family, style, size);
        return f1;
        /*
     ...
     */
    public boolean hasChar(final String family, final int style, final int size, final char c) {
        setFont(family, style, size);
