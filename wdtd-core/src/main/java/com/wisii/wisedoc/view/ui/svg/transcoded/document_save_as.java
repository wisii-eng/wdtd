...
g.setComposite(AlphaComposite.getInstance(3, 0.81142855f));
...
g.setComposite(AlphaComposite.getInstance(3, 0.69142854f));
...
g.setComposite(AlphaComposite.getInstance(3, 0.09714284f));
...
g.setComposite(AlphaComposite.getInstance(3, 0.44f));
...
g.setComposite(AlphaComposite.getInstance(3, 0.20571427f));
...
g.setComposite(AlphaComposite.getInstance(3, 0.4715909f));
...
g.setComposite(AlphaComposite.getInstance(3, 0.59659094f));
