 ...
 */
/**
 * @RemoveInlineConditionAction.java
 * 汇智互联版权所有，未经许可，不得使用
 */
 ...
 */
public class RemoveInlineConditionAction extends BaseAction
{
	...
	public boolean isAvailable()
	{
		...
		if (ranges != null && !ranges.isEmpty())
		{
			...
			{
				if (att.get(Constants.PR_CONDTION) instanceof LogicalExpression)
				{
					return true;
				} else
				{
