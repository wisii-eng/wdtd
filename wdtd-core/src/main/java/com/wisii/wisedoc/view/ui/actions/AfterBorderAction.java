 ...
 */
public class AfterBorderAction extends Actions {
	...
	private void setProperties(){
		...
		if (RibbonUIModel.getCurrentPropertiesByType().get(this.actionType).containsKey(Constants.PR_BORDER_AFTER_WIDTH)) {
			if (RibbonUIModel.getCurrentPropertiesByType().get(this.actionType).get(Constants.PR_BORDER_AFTER_WIDTH) != null) {
