...
/**
 * 类功能描述：在当前单元格的右侧插入一新单元格
 * 
 * 作者：zhangqiang 创建日期：2009-2-9
 */
public class AddTableCellRightAction extends OnlyInOneTableCellAction
{
	public void doAction(ActionEvent e)
	{
		...
		for (int i = 0; (i < rowspan) && (tr != null); i++)
		{
			...
			doc.insertElements(tablecells, tr, index+1);
