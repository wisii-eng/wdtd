...
/**
 * 块容器相对其父亲reference-area左边的距离
 * 
 * @author 闫舒寰
 * @version 1.0 2009/02/04
 */
@SuppressWarnings("serial")
public class BlockContainerLeftPositionAction extends Actions
{
	...
	public void doAction(ActionEvent e)
	{
		if (e.getSource() instanceof FixedLengthSpinner)
		{
			...
			setFOProperty(Constants.PR_LEFT, value.getValue());
		}
	}
	...
	protected void uiStateChange(UIStateChangeEvent evt)
	{
		...
		if (hasPropertyKey(Constants.PR_LEFT))
		{
