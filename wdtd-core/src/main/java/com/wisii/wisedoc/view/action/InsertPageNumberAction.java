 ...
 */
public class InsertPageNumberAction extends InsertObjectAction
{
	...
	protected List<CellElement> creatCells()
	{
		...
		PageNumber pagenumber = new PageNumber(inlineatt);
		List<CellElement> inserts = new ArrayList<CellElement>();
		inserts.add(pagenumber);
		return inserts;
	}
