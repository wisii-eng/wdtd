...
public class ParagraphTextAlignStartAction extends Actions
{

	public void doAction(ActionEvent e)
	{
		Map<Integer, Object> atts = new HashMap<Integer, Object>();
		atts.put(Constants.PR_TEXT_ALIGN, new EnumProperty(Constants.EN_START,
				""));
		atts.put(Constants.PR_TEXT_ALIGN_LAST, new EnumProperty(
				Constants.EN_START, ""));
				...
				ui
						...
						.setSelected(
								ta instanceof EnumProperty
										&& ((EnumProperty) ta).getEnum() == Constants.EN_START);
			}
		}
	}
