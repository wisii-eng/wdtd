...
public class BarcodeType25DefaultAction extends BarcodeDefaultAction {
	
	boolean BARCODE_DEFAULT_ADDCHECKSUM = false;
	double BARCODE_DEFAULT_WIDE_TO_NARROW = 3.0;
	double BARCODE_DEFAULT_QUIET_VERTICAL = 0;
	...
	protected void initValue() {
		...
		BARCODE_DEFAULT_MODULE = 0.305;
		BARCODE_DEFAULT_QUIET_HORIZONTAL = 0;
	...
	public void doAction(ActionEvent e) {
		//barcode类型
		barcodeProperties.put(Constants.PR_BARCODE_TYPE, new EnumProperty(Constants.EN_2OF5, ""));		
...
//		setFOProperties(barcodeProperties);
	}
