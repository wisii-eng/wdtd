 ...
 */
public class SetDynamicStyleBand implements WiseBand
{
	...
	{
		JRibbonBand setBand = new JRibbonBand(RibbonUIText.SET_DYNAMIC_STYLE,
		...
		RibbonUIManager.getInstance().bind(
				Font.SET_CURRENT_INLINE_DYNAMIC_STYLE, inline);
		setBand.addCommandButton(inline, RibbonElementPriority.TOP);
		...
		RibbonUIManager.getInstance().bind(
				Paragraph.SET_CURRENT_BLOCK_DYNAMIC_STYLE, block);
		setBand.addCommandButton(block, RibbonElementPriority.TOP);
		...
		RibbonUIManager.getInstance().bind(
				Defalult.SET_CURRENT_OBJECT_DYNAMIC_STYLE, object);
		setBand.addCommandButton(object, RibbonElementPriority.TOP);
		...
		RibbonUIManager.getInstance().bind(
				Defalult.SET_CURRENT_PAGE_SEQUENCE_DYNAMIC_STYLE, pagesequence);
		setBand.addCommandButton(pagesequence, RibbonElementPriority.TOP);
		...
		RibbonUIManager.getInstance().bind(
				Defalult.SET_CURRENT_WISEDOCEMENT_DYNAMIC_STYLE, document);
		setBand.addCommandButton(document, RibbonElementPriority.TOP);
