 ...
 */
public class SvgGraphicArrowStartStyle extends Actions {
	...
	private void setProperty(final int index){
		setFOProperty(Constants.PR_SVG_ARROW_START_TYPE, index);
	}
	
	@Override
	protected void uiStateChange(final UIStateChangeEvent evt) {
		super.uiStateChange(evt);
		if (hasPropertyKey(Constants.PR_SVG_ARROW_START_TYPE)) {
