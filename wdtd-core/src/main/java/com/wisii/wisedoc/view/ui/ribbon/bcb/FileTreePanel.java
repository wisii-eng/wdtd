	...
	public FileTreePanel() {
		...
		tree.addTreeSelectionListener(new TreeSelectionListener() {
			...
			public void valueChanged(TreeSelectionEvent e) {
				...
				List<FileTreeNode> ftnList = new ArrayList<FileTreeNode>();
				
				for (Object oo : o) {
					if (oo instanceof FileTreeNode) {
						FileTreeNode ftn = (FileTreeNode) oo;
						ftnList.add(ftn);
					}
				}
				
//				System.out.println(ftnList.get(ftnList.size()-1).file);
			}
		});
