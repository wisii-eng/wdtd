 ...
 */
public class PageEditSimpleMasterLayoutAction extends Actions {
	...
	public boolean isAvailable() {
		...
		if (RibbonUIModel.getCurrentPropertiesByType().get(this.actionType).get(Constants.PR_SIMPLE_PAGE_MASTER) == null) {
			return false;
		} else {
			return true;
		}
