...
public class RemoveInlineDynamicStyleAction extends BaseAction
{
	...
	public void doAction(ActionEvent e)
	{
		...
		if (doc != null)
		{
			...
			RibbonUIModel.getCurrentPropertiesByType().get(ActionType.INLINE).remove(Constants.PR_DYNAMIC_STYLE);
		}
	}
