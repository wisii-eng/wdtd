 ...
 * 创建日期：2008-11-28
 */
public class OutputSetBand implements WiseBand
{
	...
	{
		JRibbonBand inputSetBand = new JRibbonBand(RibbonUIText.DATE_TIME_OUTPUT_BAND, MediaResource.getResizableIcon("09379.ico"),new DetailSet());
		inputsetpanel = new DateTimeFormatSetPanel(true);
	...
	private class DetailSet extends BaseAction
	{
		public void doAction(ActionEvent e)
		{
			...
			if (elements != null && !elements.isEmpty())
			{
				...
				if (oldformat == null)
				{
					oldformat = (WisedocDateTimeFormat) InitialManager
							.getInitialValue(Constants.PR_DATETIMEFORMAT, null);
				}
			} else
			{
				return;
			}
			DateTimeSetDialog dtsetdia = new DateTimeSetDialog(oldformat, false);
