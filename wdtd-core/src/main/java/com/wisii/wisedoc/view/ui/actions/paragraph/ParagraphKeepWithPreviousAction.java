...
public class ParagraphKeepWithPreviousAction extends Actions {
	...
	private void getComponents(){
		...
		Set<List<Object>> comSet0 = RibbonUIManager.getUIComponents().get(Paragraph.KEEP_WITH_PREVIOUS_ACTION).get(ActionCommandType.DIALOG_ACTION);
	...
	public void doAction(ActionEvent e) {
		...
		if (e.getSource() instanceof JComboBox) {
			...
			getComponents();
			EnumProperty line = new EnumProperty(getProperty(keepWithPrevious.get(0)),"");
			EnumProperty column = new EnumProperty(getProperty(keepWithPrevious.get(1)),"");
			EnumProperty page = new EnumProperty(getProperty(keepWithPrevious.get(2)),"");
			...
			setFOProperty(Constants.PR_KEEP_WITH_PREVIOUS, keep);
		}
	...
	public void setDefaultState(ActionCommandType actionCommand) {
		...
		if (actionCommand == ActionCommandType.DIALOG_ACTION) {
			...
			Object currnetValue =  RibbonUIModel.getCurrentPropertiesByType().get(this.actionType).get(Constants.PR_KEEP_WITH_PREVIOUS);
