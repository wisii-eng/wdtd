 ...
 * 创建日期：2009-9-17
 */
public class EncryptTextTask implements WiseTask
{
	...
	{
		JRibbonBand encrtpyband = new EncryptTextBand().getBand();
		return new RibbonTask("设置", encrtpyband);
	}
