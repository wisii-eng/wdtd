...
public class FontPanel extends JPanel {
	...
	public FontPanel() {
		...
		Border empty = BorderFactory.createEmptyBorder(0, 8, 0, 8);
		/* 【添加：END】by 李晓光 2009-1-6 */
		JPanel panelAll = new JPanel();
		Border border = BorderFactory.createCompoundBorder(empty, BorderFactory.createTitledBorder(UiText.FONT_COLOR_BORDER_LABEL));
		...
		panel_1 = new JPanel();
		/* 【添加：START】by 李晓光 2009-1-6 */
		Border border_1 = BorderFactory.createCompoundBorder(empty, BorderFactory.createTitledBorder(UiText.FONT_EFFECT_BORDER_LABEL));
		/* 【添加：END】by 李晓光 2009-1-6 */
		...
		panel_2 = new JPanel();
		/* 【添加：START】by 李晓光 2009-1-6 */
		Border border_2 =  BorderFactory.createCompoundBorder(empty, BorderFactory.createTitledBorder(UiText.PREVIEW_BORDER_LABEL));
		/* 【添加：END】by 李晓光 2009-1-6 */
		panel_2.setBorder(border_2);
		panel_2.setLayout(new BorderLayout());
		
		WisedocConfigurePreviewPanel previewPanel = WisedocConfigurePreviewPanel.getInstance();
	...
	private Map<Integer, Object> filterMap(Map<Integer, Object> map)
	{
		Integer[] keys =
		{ Constants.PR_FONT_FAMILY, Constants.PR_FONT_SIZE,
				Constants.PR_FONT_STYLE, Constants.PR_FONT_WEIGHT,
				Constants.PR_TEXT_DECORATION, Constants.PR_COLOR };
	...
	private class FontColorPanel extends JPanel{
		...
		FontColorPanel(){
			...
			//颜色层标签
			JLabel labLayer = new JLabel(UiText.FONT_COLOR_LAYER_LABEL);
			//颜色层设置
			WiseCombobox comLayer = new LayerComboBox();
			
			//颜色监听器
			RibbonUIManager.getInstance().bind(Font.COLOR_ACTION, ActionCommandType.DIALOG_ACTION, color_comboBox, comLayer);
...
//			font_style_comboBox.setEditable(true);
			...
			//字号监听器
			RibbonUIManager.getInstance().bind(Font.SIZE_ACTION, ActionCommandType.DIALOG_ACTION, font_size_comboBox);
			//字体监听器
			RibbonUIManager.getInstance().bind(Font.FAMILY_ACTION, ActionCommandType.DIALOG_ACTION, font_family_comboBox);
			//字形监听器
			RibbonUIManager.getInstance().bind(Font.STYLE_ACTION, ActionCommandType.DIALOG_ACTION, font_style_comboBox);
			//颜色监听器
			/*RibbonUIManager.getInstance().bind(Font.COLOR_ACTION, ActionCommandType.DIALOG_ACTION, color_comboBox);*/
	...
	private class FontEffect extends JPanel{
		...
		public FontEffect() {
			...
			RibbonUIManager.getInstance().bind(Font.UNDERLINE_ACTION, ActionCommandType.DIALOG_ACTION, underline_checkBox);
			RibbonUIManager.getInstance().bind(Font.OVERLINE_ACTION, ActionCommandType.DIALOG_ACTION, checkBox_2);
			RibbonUIManager.getInstance().bind(Font.LINE_THROUGH_ACTION, ActionCommandType.DIALOG_ACTION, lineThroughCheckBox);
