...
g.setComposite(AlphaComposite.getInstance(3, 0.28021976f));
...
g.setComposite(AlphaComposite.getInstance(3, 0.4450549f));
...
g.setComposite(AlphaComposite.getInstance(3, 0.48295456f));
...
g.setComposite(AlphaComposite.getInstance(3, 0.35795456f));
