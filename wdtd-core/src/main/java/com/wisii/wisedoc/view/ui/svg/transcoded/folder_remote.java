...
g.setComposite(AlphaComposite.getInstance(3, 0.83707863f));
...
g.setComposite(AlphaComposite.getInstance(3, 0.11363632f));
...
g.setComposite(AlphaComposite.getInstance(3, 0.5568182f));
...
g.setComposite(AlphaComposite.getInstance(3, 0.45142856f));
...
g.setComposite(AlphaComposite.getInstance(3, 0.4659091f));
