 ...
 */
public class FontPositionPanelDynamic extends JPanel {
	 ...
	 * Create the panel
	 */
	public FontPositionPanelDynamic() {
		super();
//		setPreferredSize(new Dimension(237, 140));
		...
		RibbonUIManager.getInstance().bind(Font.POSITION_INPUT_ACTION, ActionCommandType.DYNAMIC_ACTION, fontPositionValueSpinner);//, comboBox_1
		RibbonUIManager.getInstance().bind(Font.POSITION_ACTION, ActionCommandType.DYNAMIC_ACTION, fontPositionCombox);
		
		
		//词间距监听器
		RibbonUIManager.getInstance().bind(Font.SPACE_INPUT_ACTION, ActionCommandType.DYNAMIC_ACTION, fontSpaceValueSpinner);//, comboBox_2
		RibbonUIManager.getInstance().bind(Font.SPACE_ACTION, ActionCommandType.DYNAMIC_ACTION, fontSpaceCombobox);
		...
		//词间距监听器
		RibbonUIManager.getInstance().bind(Font.WORD_SPACE_INPUT_ACTION, ActionCommandType.DYNAMIC_ACTION, fontWordSpaceSpinner);//
		RibbonUIManager.getInstance().bind(Font.WORD_SPACE_ACTION, ActionCommandType.DYNAMIC_ACTION, fontWordSpaceComboBox);
