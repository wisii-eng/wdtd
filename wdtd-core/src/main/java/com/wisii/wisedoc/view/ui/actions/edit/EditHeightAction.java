...
public class EditHeightAction extends AbstractEditAction
{
	...
	public void doAction(ActionEvent e)
	{
		if (e.getSource() instanceof FixedLengthSpinner)
		{
			...
			setFOProperty(Constants.PR_EDIT_HEIGHT, length);
		}
	}
	...
	protected void uiStateChange(UIStateChangeEvent evt)
	{
		...
		if (uiComponent instanceof FixedLengthSpinner
				&& hasPropertyKey(Constants.PR_EDIT_HEIGHT))
		{
	...
	protected void setDifferentPropertyState(UIStateChangeEvent evt)
	{
		...
		if (evt.hasPropertyKey(Constants.PR_EDIT_HEIGHT))
		{
			if (uiComponent instanceof FixedLengthSpinner)
			{
