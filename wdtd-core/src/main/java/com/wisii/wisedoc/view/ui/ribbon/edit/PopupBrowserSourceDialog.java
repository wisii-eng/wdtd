 ...
 */
public class PopupBrowserSourceDialog extends AbstractWisedocDialog
{

	PopupBrowserSourcePanel datasourcepanel;
	...
	public PopupBrowserSourceDialog(AbstractWisedocDialog parent,
			DataSource datasource)
	{
		super(parent, RibbonUIText.DATASOURCE_SWINGDS_TITLE, true);
		this.datasource = datasource;
		datasourcepanel = new PopupBrowserSourcePanel(datasource);
