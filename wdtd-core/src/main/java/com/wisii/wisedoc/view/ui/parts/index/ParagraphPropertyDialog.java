...
import com.wisii.wisedoc.view.dialog.ParagraphPanel;
 ...
 */
public class ParagraphPropertyDialog extends AbstractWisedocDialog {
	
	BorderPanel borderPanel;
	
	public static ParagraphPropertyDialog paragraphPropertyDialog;
	ActionType actionType;
	JTabbedPane tabs;
	
	ParagraphPanel propertyPanel;
	
	public ParagraphPropertyDialog() {
		super();
	}
	
	public ParagraphPropertyDialog(final ActionType actionType){
		this();
		
		this.actionType = actionType;
		paragraphPropertyDialog = this;
		...
		property.putAll(RibbonUIModel.getDefaultPropertiesByType().get(ActionType.BLOCK));
		property.putAll(IndexStylesModel.Instance.getProperty());
//		System.out.println(IndexStylesModel.Instance.getProperty());
	...
	class ButtonAction extends Actions{
		...
		public void doAction(final ActionEvent e) {
			...
			if(cmd.equals(UiText.DIALOG_OK)){
				IndexStylesModel.Instance.setPropertise(propertyPanel.getSetting());
				paragraphPropertyDialog.dispose();
