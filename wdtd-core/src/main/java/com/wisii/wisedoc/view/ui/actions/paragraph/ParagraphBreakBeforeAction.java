...
public class ParagraphBreakBeforeAction extends Actions {
		...
		if (e.getSource() instanceof JComboBox) {
			...
			if (true) {
				...
				if (jb.getSelectedIndex() == 0) {
					...
					setFOProperty(Constants.PR_BREAK_BEFORE, new EnumProperty(Constants.EN_AUTO, "break before"));
					
				} else if (jb.getSelectedIndex() == 1){
					
					setFOProperty(Constants.PR_BREAK_BEFORE, new EnumProperty(Constants.EN_PAGE, "break before"));
					...
					setFOProperty(Constants.PR_BREAK_BEFORE, new EnumProperty(Constants.EN_EVEN_PAGE, "break before"));
					...
					setFOProperty(Constants.PR_BREAK_BEFORE, new EnumProperty(Constants.EN_ODD_PAGE, "break before"));
					...
					setFOProperty(Constants.PR_BREAK_BEFORE, new EnumProperty(Constants.EN_COLUMN, "break before"));
