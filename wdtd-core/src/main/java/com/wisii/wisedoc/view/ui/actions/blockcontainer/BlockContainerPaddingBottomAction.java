...
public class BlockContainerPaddingBottomAction extends Actions
{
	...
	public void doAction(ActionEvent e)
	{
		...
		if (e.getSource() instanceof FixedLengthSpinner)
		{
			...
			if (length != null)
			{
				...
				setFOProperty(Constants.PR_PADDING_AFTER, len);
			}
		}
	}
	...
	protected void uiStateChange(UIStateChangeEvent evt)
	{
		...
		if (hasPropertyKey(Constants.PR_PADDING_AFTER))
		{
	...
	public void setDefaultState(ActionCommandType actionCommand)
	{
		...
		{
			FixedLengthSpinner ui = (FixedLengthSpinner) uiComponent;
			CondLengthProperty len = (CondLengthProperty) InitialManager.getInitialValue(Constants.PR_PADDING_AFTER, null);
			if(len!=null)
			{
