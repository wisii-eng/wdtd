...
public class RegionEndOverflowAction extends DefaultSimplePageMasterActions
{
	...
	private void setProperty(int index)
	{
		...
		{
			case 0:
				current = setRegionEndOverflow(Constants.EN_VISIBLE);
				break;
			case 1:
				current = setRegionEndOverflow(Constants.EN_HIDDEN);
				break;
		}
