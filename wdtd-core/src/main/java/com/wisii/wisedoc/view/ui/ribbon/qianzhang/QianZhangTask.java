 ...
 * 创建日期：2008-12-23
 */
public class QianZhangTask implements WiseTask
{
	...
	{
		JRibbonBand insertband = new InsertBand().getBand();
		RibbonTask task = new RibbonTask(RibbonUIText.QIANZHANG_TASK,insertband);
		return task;
	}
}
