 ...
 */
public class OutputSeperatorAction extends AbstractDateTimeInfoSetAction
{
	...
	protected void UpDateUI()
	{
		if (uiComponent instanceof JTextField)
		{
			...
			String text = oldformat.getOutseperate();
			if (text != null)
			{
				tf.setText(text);
			} else
	...
	protected WisedocDateTimeFormat createformat(ActionEvent e)
	{
		...
		if (e.getSource() instanceof JTextField)
		{
			...
			return new WisedocDateTimeFormat(oldformat.getDatein(), oldformat
					...
					.getTimeout(), oldformat.getInputseperate(), text);
		}
		return null;
	}
	...
	public boolean isAvailable()
	{
		...
		if (oldformat != null)
		{
			return oldformat.getDateout() != null
					&& oldformat.getTimeout() != null;
		} else
		{
			return false;
		}
