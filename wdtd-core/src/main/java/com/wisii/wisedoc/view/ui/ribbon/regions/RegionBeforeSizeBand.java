...
import static com.wisii.wisedoc.view.ui.text.RibbonUIText.REGION_BEFORE_PRECEDENCE;
 ...
 */
public class RegionBeforeSizeBand
{
	...
	public JRibbonBand getBand()
	{
		...
		FixedLengthSpinner extent = new FixedLengthSpinner(
				new SpinnerFixedLengthModel(null, new FixedLength(0d, "mm"),
						null, -1));
		RibbonUIManager.getInstance().bind(RegionBefore.EXTENT_ACTION, extent);
		...
		JCheckBox footerCheck = new JCheckBox(REGION_BEFORE_PRECEDENCE);
		RibbonUIManager.getInstance().bind(RegionBefore.PRECEDENCE_ACTION,
				footerCheck);
