...
public class SvgPanel extends JPanel implements PropertyPanelInterface
{
	...
	public SvgPanel(List<CellElement> selectsobj)
	{
		this(selectsobj, 0);
	}

	public SvgPanel(List<CellElement> selectsobj, int selectedindex)
	{
		super();
		selects = selectsobj;
