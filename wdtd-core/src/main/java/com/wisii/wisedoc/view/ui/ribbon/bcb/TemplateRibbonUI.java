...
/**
 * 这个类是为页布局序列提供支持的，这个是从BasicRibbonUI修改过来的
 * @author 闫舒寰
 * @version 1.0 2009/02/09
 */
public class TemplateRibbonUI extends RibbonUI {
	/**
...
//			FlamingoUtilities
//					.updateRibbonFrameIconImages((WisedocFrame) windowAncestor);
//		}
	}
