 ...
 */
/**
 * @WisedocChartPieShowFactValueAction.java
 * 汇智互联版权所有，未经许可，不得使用
 */
 ...
 */
public class WisedocChartPieShowFactValueAction extends Actions {
	private final int CONSTANTS_KEY = Constants.PR_PIE_FACT_VALUE_VISABLE;
