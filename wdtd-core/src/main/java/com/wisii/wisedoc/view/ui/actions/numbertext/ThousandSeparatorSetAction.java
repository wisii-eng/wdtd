 ...
 */
public class ThousandSeparatorSetAction extends Actions
{
	...
	private NumberFormat getNumberformat(boolean hasthans)
	{

		NumberFormat nf = null;
		if (oldformat != null)
		{
			nf = new NumberFormat(oldformat.getDecimalDigits(), hasthans,
					oldformat.isIsbaifenbi());
		} else
		{
		...
		if (hasPropertyKey(Constants.PR_NUMBERFORMAT))
		{
			...
			if (uiComponent instanceof JCheckBox)
			{
				...
				if (obj instanceof NumberFormat)
				{
					...
					ui.setSelected(oldformat.isHasthousseparator());
					//					
					// if (oldformat.getThousandSeparator() != null)
					// {
					// ui.setText(oldformat.getDecimalSeparator());
					// } else
					// {
					// ui.setText("");
					// }
