 ...
 * 创建日期：2009-12-21
 */
public class ConnWithBand implements WiseBand
{
	...
	public JRibbonBand getBand()
	{
		...
		RibbonUIManager.getInstance().bind(CheckBox.EDIT_CONNWITH_ACTION,
				connwithbutton);
		...
		final JCommandButton reomveconnwithbutton = new JCommandButton(
				RibbonUIText.EDIT_REMOVE, MediaResource
						.getResizableIcon("03466.ico"));
		RibbonUIManager.getInstance().bind(CheckBox.REMOVE_CONNWITH_ACTION,
