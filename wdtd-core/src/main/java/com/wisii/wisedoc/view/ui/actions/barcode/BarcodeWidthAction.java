...
/**
 * 定义条码基本单元（条/空）的宽度，在此为窄单元宽度，即标称尺寸X（或实际尺寸Z）
 * @author 闫舒寰
 * @version 1.0 2009/02/03
 */
public class BarcodeWidthAction extends Actions
{

	/**
	 * TODO
	 * 应不小于0.25mm，宜在0.25mm～0.43mm，具体大小取决于标签厂商/打印机的精度
	 * 这里还应该有个输入范围的确认
	 */
	...
	public void doAction(ActionEvent e)
	{
		if (e.getSource() instanceof FixedLengthSpinner)
		{
			...
			setFOProperty(Constants.PR_BARCODE_MODULE, value.getValue());
		}
	}
	...
	protected void uiStateChange(UIStateChangeEvent evt)
	{
		...
		if (hasPropertyKey(Constants.PR_BARCODE_MODULE))
		{
