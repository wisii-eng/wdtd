...
public class RegionStartDisplayAlignAction extends
		DefaultSimplePageMasterActions
{
	...
	private void setProperty(int index)
	{
		...
		switch (index)
		{
			case 0:
				// 上对齐
				current = setRegionStartDisplayAlign(Constants.EN_BEFORE);
				break;
			case 1:
				// 居中
				current = setRegionStartDisplayAlign(Constants.EN_CENTER);
				break;
			case 2:
				// 下对齐
				current = setRegionStartDisplayAlign(Constants.EN_AFTER);
				break;
