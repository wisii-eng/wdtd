...
public class RemoveDatatreatXpathPositionAction extends BaseAction
{
	...
	public void doAction(ActionEvent e)
	{
		...
		if (doc != null)
		{
			...
			attrs.put(Constants.PR_XPATH_POSITION, null);
	...
	public boolean isAvailable()
	{
		...
		if (ranges != null && !ranges.isEmpty())
		{
			...
			if (att != null)
			{
				return att.get(Constants.PR_XPATH_POSITION) != null;
			}
		}
		return false;
	}
