 ...
 */
public class AllBorderAction extends Actions {
	...
	private void setProperties(){
		...
		//设置四个边默认的宽度
		properties.put(Constants.PR_BORDER_BEFORE_WIDTH, convertLength(0.5d, "pt"));
		properties.put(Constants.PR_BORDER_AFTER_WIDTH, convertLength(0.5d, "pt"));
		properties.put(Constants.PR_BORDER_START_WIDTH, convertLength(0.5d, "pt"));
		properties.put(Constants.PR_BORDER_END_WIDTH, convertLength(0.5d, "pt"));
		//设置四个边默认的样式
		properties.put(Constants.PR_BORDER_BEFORE_STYLE, convertStyle(4));
		properties.put(Constants.PR_BORDER_AFTER_STYLE, convertStyle(4));
		properties.put(Constants.PR_BORDER_START_STYLE, convertStyle(4));
		properties.put(Constants.PR_BORDER_END_STYLE, convertStyle(4));
		//设置四个边默认的颜色
		properties.put(Constants.PR_BORDER_BEFORE_COLOR, convertColor());
		properties.put(Constants.PR_BORDER_AFTER_COLOR, convertColor());
		properties.put(Constants.PR_BORDER_START_COLOR, convertColor());
