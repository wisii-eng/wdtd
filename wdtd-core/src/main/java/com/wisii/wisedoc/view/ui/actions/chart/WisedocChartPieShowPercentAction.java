 ...
 */
/**
 * @WisedocChartPieShowPercentAction.java
 * 汇智互联版权所有，未经许可，不得使用
 */
 ...
 */
public class WisedocChartPieShowPercentAction extends Actions {
	private final int CONSTANTS_KEY = Constants.PR_PERCENTVALUE_VISABLE;
