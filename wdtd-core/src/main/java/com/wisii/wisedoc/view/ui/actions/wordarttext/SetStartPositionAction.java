 ...
 * 创建日期：2009-9-15
 */
public class SetStartPositionAction extends Actions
{
	...
	public void doAction(ActionEvent e)
	{
		if (e.getSource() instanceof WiseSpinner)
		{
			...
			setFOProperty(Constants.PR_WORDARTTEXT_STARTPOSITION, widthsp.getValue());
		}
	}
	...
	protected void uiStateChange(UIStateChangeEvent evt)
	{
		...
		if (uiComponent instanceof WiseSpinner
				&& hasPropertyKey(Constants.PR_WORDARTTEXT_STARTPOSITION))
		{
	...
	{
		if (evt.hasPropertyKey(Constants.PR_WORDARTTEXT_STARTPOSITION))
		{
			if (uiComponent instanceof WiseSpinner)
			{
