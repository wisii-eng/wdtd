 ...
 */
public class BarcodeType128DefaultAction extends BarcodeDefaultAction {	
	...
	public void doAction(ActionEvent e) {
		//barcode类型
		barcodeProperties.put(Constants.PR_BARCODE_TYPE, new EnumProperty(Constants.EN_CODE128, ""));		
