...
public class RegionAfterWritingModeAction extends
		DefaultSimplePageMasterActions
{
	...
	private void setProperty(int index)
	{
		...
		{
			case 0:
				current = setRegionAfterWritingMode(Constants.EN_LR_TB);
				break;
			case 1:
				current = setRegionAfterWritingMode(Constants.EN_RL_TB);
				break;
			case 2:
				current = setRegionAfterWritingMode(Constants.EN_TB_RL);
				break;
			default:
				current = setRegionAfterWritingMode(Constants.EN_LR_TB);
				break;
