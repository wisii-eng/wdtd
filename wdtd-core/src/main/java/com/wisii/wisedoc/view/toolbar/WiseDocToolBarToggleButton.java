 ...
 */
/**
 * @WiseDocToolBarToggleButton.java
 * 汇智互联版权所有，未经许可，不得使用
 */
...
/**
 * 类功能描述：定义自己风格的ToggleButton
 *
 * 作者：李晓光
 * 创建日期：2008-08-22
 */
public class WiseDocToolBarToggleButton extends JToggleButton
{
	public WiseDocToolBarToggleButton()
	{
		super();
