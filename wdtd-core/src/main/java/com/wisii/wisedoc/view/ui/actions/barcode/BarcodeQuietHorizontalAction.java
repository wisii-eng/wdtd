...
/**
 * 定义条码左右两端外侧空白区大小，即空白区宽度
 * 
 * @author 闫舒寰
 * @version 1.0 2009/02/03
 */
public class BarcodeQuietHorizontalAction extends Actions {

	@Override
	public void doAction(ActionEvent e) {
		if (e.getSource() instanceof FixedLengthSpinner) {
			FixedLengthSpinner value = (FixedLengthSpinner) e.getSource();
			setFOProperty(Constants.PR_BARCODE_QUIET_HORIZONTAL, value
					.getValue());
		}
	}
	...
	protected void uiStateChange(UIStateChangeEvent evt) {
		...
		if (hasPropertyKey(Constants.PR_BARCODE_QUIET_HORIZONTAL)) {
