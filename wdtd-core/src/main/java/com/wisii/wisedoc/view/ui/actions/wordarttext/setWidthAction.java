 ...
 * 创建日期：2009-9-15
 */
public class setWidthAction extends Actions
{
	...
	public void doAction(ActionEvent e)
	{
		if (e.getSource() instanceof FixedLengthSpinner)
		{
			...
			setFOProperty(Constants.PR_WIDTH, widthsp.getValue());
		}
	}
	...
	protected void uiStateChange(UIStateChangeEvent evt)
	{
		...
		if (uiComponent instanceof FixedLengthSpinner
				&& hasPropertyKey(Constants.PR_WIDTH))
		{
	...
	{
		if (evt.hasPropertyKey(Constants.PR_WIDTH))
		{
			if (uiComponent instanceof FixedLengthSpinner)
			{
