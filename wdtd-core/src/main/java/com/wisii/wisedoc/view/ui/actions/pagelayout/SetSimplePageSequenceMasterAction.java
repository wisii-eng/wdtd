...
import com.wisii.wisedoc.view.dialog.SimpleMasterDialog;
import com.wisii.wisedoc.view.ui.StaticContentManeger;
import com.wisii.wisedoc.view.ui.actions.Actions;
import com.wisii.wisedoc.view.ui.model.RibbonUIModel;

@SuppressWarnings("serial")
public class SetSimplePageSequenceMasterAction extends Actions
{
	...
	public void doAction(ActionEvent e)
	{
		if (e.getSource() instanceof JCommandButton)
		{
			...
			if (currentps != null)
			{
				...
				SimpleMasterDialog dia = new SimpleMasterDialog(master,
						staticcontentmap);
				if (dia.showDialog() == DialogResult.OK)
				{
					Object newspm = dia.getMaster();
					Document doc = SystemManager.getCurruentDocument();

					doc.deleteElements(delete, currentps);
					if (newspm instanceof SimplePageMaster)
					{
						setFOProperty(Constants.PR_SIMPLE_PAGE_MASTER, newspm);
					} else if (newspm instanceof PageSequenceMaster)
					{
						setFOProperty(Constants.PR_PAGE_SEQUENCE_MASTER, newspm);
					}
