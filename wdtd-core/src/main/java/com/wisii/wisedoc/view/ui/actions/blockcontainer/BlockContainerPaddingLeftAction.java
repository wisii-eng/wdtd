...
public class BlockContainerPaddingLeftAction extends Actions
{
	...
	public void doAction(ActionEvent e)
	{
		...
		if (e.getSource() instanceof FixedLengthSpinner)
		{
			...
			if (length != null)
			{
				...
				setFOProperty(Constants.PR_PADDING_START, len);
			}
		}
	}
	...
	protected void uiStateChange(UIStateChangeEvent evt)
	{
		...
		if (hasPropertyKey(Constants.PR_PADDING_START))
		{
	...
	public void setDefaultState(ActionCommandType actionCommand)
	{
		...
		{
			FixedLengthSpinner ui = (FixedLengthSpinner) uiComponent;
			CondLengthProperty len = (CondLengthProperty) InitialManager.getInitialValue(Constants.PR_PADDING_START, null);
			if(len!=null)
			{
