 ...
 */
/**
 * @WisedocChartDepth3DAction.java
 * 汇智互联版权所有，未经许可，不得使用
 */
 ...
 */
public class WisedocChartDepth3DAction extends Actions {
	private final int CONSTANTS_KEY = Constants.PR_3DDEPNESS;
	...
	public boolean isAvailable() {
		...
		final EnumProperty pro = (EnumProperty) chart
				.getAttribute(Constants.PR_3DENABLE);
		if (pro == null) {
			return Boolean.FALSE;
		}
		return (pro.getEnum() == Constants.EN_TRUE);
	}
}
