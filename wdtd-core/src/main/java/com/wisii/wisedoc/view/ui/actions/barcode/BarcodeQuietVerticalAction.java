...
/**
 * 定义条码字符上下外侧空白大小，即空白高度
 * 
 * @author 闫舒寰
 * @version 1.0 2009/02/03
 */
public class BarcodeQuietVerticalAction extends Actions {

	@Override
	public void doAction(ActionEvent e) {
		if (e.getSource() instanceof FixedLengthSpinner) {
			FixedLengthSpinner value = (FixedLengthSpinner) e.getSource();
			setFOProperty(Constants.PR_BARCODE_QUIET_VERTICAL, value.getValue());
		}
	}
	...
	protected void uiStateChange(UIStateChangeEvent evt) {
		...
		if (hasPropertyKey(Constants.PR_BARCODE_QUIET_VERTICAL)) {
