...
public class SaveAsWSDMFileAction extends BaseAction
{

	public SaveAsWSDMFileAction()
	{
		super();
	}
	 ...
	 *            指定Action的名字。
	 */
	public SaveAsWSDMFileAction(String name)
	{
		super(name);
	}
	 ...
	 *            指定Action的图标。
	 */
	public SaveAsWSDMFileAction(String name, Icon icon)
	{
		super(name, icon);
	}
	 ...
	 * 
	 */
	public void SaveAsWSDMFile(Document document)
	{
		...
		chooser.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent evt)
			{
						...
						.getActionCommand()))
				{
					...
					if (IOUtil.isExists(chooser.getSelectedFile(), "wsdm"))
					{
		...
		if (result == DialogResult.OK)
		{
			...
			if (!filename.endsWith(".wsdm"))
			{
				filename += ".wsdm";
			}
			IOUtil.savaFile(document, new File(filename));
		}
	}
