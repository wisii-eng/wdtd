...
public class XpathPositionBand implements WiseBand
{

	@Override
	public JRibbonBand getBand()
	{
		JRibbonBand visibleGroupBand = new JRibbonBand(RibbonUIText.NODE_XPATH,
				MediaResource.getResizableIcon("09379.ico"), null);
		JCommandButton currentinline = new JCommandButton(
				RibbonUIText.XPATH_POSITION, MediaResource
