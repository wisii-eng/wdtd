...
public class PageSequenceMasterPanel extends JPanel {
	...
	public PageSequenceMasterPanel(JRadioButton simplepagemasterRadioButton) {
		super();
...
//		simplepagemasterRadioButton.setText("simple-page-master");
		...
		masterNameLabel.addPropertyChangeListener(new PropertyChangeListener(){
			...
			public void propertyChange(PropertyChangeEvent evt) {
				//把当前改动设置到当前引用的对象的属性
//				MultiPageSequenceModel.MultiPageSeqModel.getCurrentSequenceProperty().put(Constants.PR_PAGE_SEQUENCE_MASTER, evt.getNewValue());
			}
			
		});
		
//		masterNameLabel.setEditable(false);
