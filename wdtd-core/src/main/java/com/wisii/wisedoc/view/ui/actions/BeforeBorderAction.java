 ...
 * 上边框设置的动作
 * @author 闫舒寰
 * @version 1.0 2009/02/1
 */
public class BeforeBorderAction extends Actions {
	...
	private void setProperties(){
		...
		if (RibbonUIModel.getCurrentPropertiesByType().get(this.actionType).containsKey(Constants.PR_BORDER_BEFORE_WIDTH)) {
			if (RibbonUIModel.getCurrentPropertiesByType().get(this.actionType).get(Constants.PR_BORDER_BEFORE_WIDTH) != null) {
