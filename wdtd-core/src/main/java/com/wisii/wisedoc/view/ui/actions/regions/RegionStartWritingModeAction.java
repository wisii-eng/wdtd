...
public class RegionStartWritingModeAction extends
		DefaultSimplePageMasterActions
{
	...
	private void setProperty(int index)
	{
		...
		{
			case 0:
				current = setRegionStartWritingMode(Constants.EN_LR_TB);
				break;
			case 1:
				current = setRegionStartWritingMode(Constants.EN_RL_TB);
				break;
			case 2:
				current = setRegionStartWritingMode(Constants.EN_TB_RL);
				break;
			case 3:
				// FOP中没有bt-rl
