 ...
 */
public class StartBorderAction extends Actions {
	...
	private void setProperties(){
		...
		if (RibbonUIModel.getCurrentPropertiesByType().get(this.actionType).containsKey(Constants.PR_BORDER_START_WIDTH)) {
			if (RibbonUIModel.getCurrentPropertiesByType().get(this.actionType).get(Constants.PR_BORDER_START_WIDTH) != null) {
