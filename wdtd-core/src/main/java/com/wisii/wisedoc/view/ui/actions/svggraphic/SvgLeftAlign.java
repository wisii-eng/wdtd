...
public class SvgLeftAlign extends SvgAlign
{
	...
	{
		setAttribute(current,Constants.PR_LEFT, newposition);
	}
	...
	public void setLineLimit(CellElement current, FixedLength newposition)
	{
		...
		if (currentattribute != null)
		{
			...
			setAttribute(current,Constants.PR_X1, SVGUtil
					.getSubLength(x1, move));
			setAttribute(current,Constants.PR_X2, SVGUtil
	...
	public void setRectangleLimit(CellElement current, FixedLength newposition)
	{
		...
		if (currentattribute != null)
		{
			setAttribute(current,Constants.PR_X, newposition);
		}
	}
}
