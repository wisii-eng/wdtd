...
/**
 * 类功能描述：在当前表格，相对定位的块容器，组对象前新加一段落， 这个可以解决在文档开始处添加了表格等对象后不能在其前添加内容的问题
 * 
 * 作者：zhangqiang 创建日期：2009-11-26
 */
public class InsertBlockBeforeAction extends BaseAction
{
