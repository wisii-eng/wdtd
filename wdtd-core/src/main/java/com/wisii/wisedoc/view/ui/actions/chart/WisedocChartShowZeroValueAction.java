 ...
 */
/**
 * @WisedocChartShowZeroValueAction.java
 * 汇智互联版权所有，未经许可，不得使用
 */
...
/**
 * 类功能描述：用于设置在统计图中是否显示0值
 * 
 * 作者：李晓光 创建日期：2009-5-22
 */
public class WisedocChartShowZeroValueAction extends Actions {
	private final int CONSTANTS_KEY = Constants.PR_ZEROVALUE_VISABLE;
