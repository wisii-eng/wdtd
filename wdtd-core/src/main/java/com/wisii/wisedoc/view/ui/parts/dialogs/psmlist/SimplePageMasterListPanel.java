...
/**
 * 单个页布局列表面板，即simple-page-master集合
 * 
 * 目前不用！！！
 * @author 闫舒寰
 * @version 1.0 2009/02/09
 */
public class SimplePageMasterListPanel extends JPanel implements ListSelectionListener {
    ...
    private static final String addSPM = "添加 SPM";
    private static final String delSPM = "删除 SPM";
    ...
    public SimplePageMasterListPanel() {
...
//			System.err.println("hihi");
    ...
    private static void createAndShowGUI() {
        ...
        JComponent newContentPane = new SimplePageMasterListPanel();
