...
public class RemoveSimpleDatatreatTransformTableAction  extends BaseAction
{
	...
	public void doAction(ActionEvent e)
	{
		...
		if (doc != null)
		{
			...
			attrs.put(Constants.PR_TRANSFORM_TABLE, null);
	...
	public boolean isAvailable()
	{
		...
		if (ranges != null && !ranges.isEmpty())
		{
			...
			if (att != null)
			{
				return att.get(Constants.PR_TRANSFORM_TABLE) != null;
			}
		}
		return false;
	}
