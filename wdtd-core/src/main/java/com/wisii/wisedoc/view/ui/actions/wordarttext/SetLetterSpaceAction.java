 ...
 * 创建日期：2009-9-15
 */
public class SetLetterSpaceAction extends Actions
{
	...
	public void doAction(ActionEvent e)
	{
		if (e.getSource() instanceof FixedLengthSpinner)
		{
			...
			setFOProperty(Constants.PR_WORDARTTEXT_LETTERSPACE, widthsp.getValue());
		}
	}
	...
	protected void uiStateChange(UIStateChangeEvent evt)
	{
		...
		if (uiComponent instanceof FixedLengthSpinner
				&& hasPropertyKey(Constants.PR_WORDARTTEXT_LETTERSPACE))
		{
	...
	{
		if (evt.hasPropertyKey(Constants.PR_WORDARTTEXT_LETTERSPACE))
		{
			if (uiComponent instanceof FixedLengthSpinner)
			{
