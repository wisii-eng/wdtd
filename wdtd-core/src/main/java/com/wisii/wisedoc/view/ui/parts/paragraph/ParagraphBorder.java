 ...
 * @since	2008/09/27
 */
public class ParagraphBorder extends JPanel {
...
//		comboBox_1.setSelectedIndex(4);
		...
		button_1.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				new BorderAndBackGroundDialog(ActionType.BLOCK);
			}
		...
		//单选是否设置边框
//		checkBox.addActionListener(actionFactory.createAction(ActionConstants.PARAGRAPH_BORDER_SETTING_ACTION, paragraphBorder));
		//添加边框宽度监听器
		/*spinner.addChangeListener(actionFactory.createAction(ActionConstants.PARAGRAPH_BORDER_WIDTH_ACTION, paragraphBorder));
		comboBox.addActionListener(actionFactory.createAction(ActionConstants.PARAGRAPH_BORDER_WIDTH_ACTION, paragraphBorder));
		BorderColorComboBox.addActionListener(actionFactory.createAction(ActionConstants.PARAGRAPH_BORDER_COLOR_ACTION, paragraphBorder));
		comboBox_1.addActionListener(actionFactory.createAction(ActionConstants.PARAGRAPH_BORDER_STYLE_ACTION, paragraphBorder));*/
