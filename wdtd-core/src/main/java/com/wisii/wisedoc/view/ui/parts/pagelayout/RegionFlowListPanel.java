...
public class RegionFlowListPanel extends JPanel implements ListSelectionListener {
	
	/*private volatile static SimplePageMasterList uniqueInstance;
	
	private SimplePageMasterList(){
		 super(new BorderLayout());
		 initSimplePageMasterList();
	}
	
	public static SimplePageMasterList getInstance(){
		if (uniqueInstance == null) {
			synchronized (SimplePageMasterList.class) {
				uniqueInstance = new SimplePageMasterList();
			}
		}
    ...
    private static final String addSPM = "添加流";
    private static final String delSPM = "删除流";
    ...
    public RegionFlowListPanel() {
        ...
        Set<String> nameSet =RegionDocumentManager.Instance.getRegionFlowsMap().keySet();
        
        
        
        String[] listItems = nameSet.toArray(new String[nameSet.size()]);
...
//        list.addListSelectionListener(SimplePageMasterListListener.SPMLL);
...
//        String name = listModel.getElementAt(list.getSelectedIndex()).toString();
        ...
        panel.add(new JLabel("四区域所对应流列表"));
...
//			System.err.println("hihi");
    ...
    private static void createAndShowGUI() {
        ...
        JComponent newContentPane = new RegionFlowListPanel();
