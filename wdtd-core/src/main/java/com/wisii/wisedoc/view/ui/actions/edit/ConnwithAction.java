 ...
 * 创建日期：2009-9-1
 */
public class ConnwithAction extends AbstractEditAction
{
	...
	public void doAction(ActionEvent e)
	{
		...
		ConnWith connwith = null;
		if (attrs != null)
		{
			connwith = (ConnWith) attrs.get(Constants.PR_CONN_WITH);
		}
		ConnectWithDialog dialog = new ConnectWithDialog(connwith);
		DialogResult result = dialog.showDialog();
		if (result == DialogResult.OK)
		{
			ConnWith ninfo = dialog.getConwith();
			setFOProperty(Constants.PR_CONN_WITH, ninfo);
		}
	}
