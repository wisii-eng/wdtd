 ...
 */
public class ImageFileFilter extends WiseDocFileFilter {
	/* 定义文件选择器，下拉框显示的内容。 */
	private final static String descript = MessageResource
			.getMessage(MessageConstants.DIALOG_COMMON
					+ MessageConstants.IMAGEDIALOGFILEDESCRIPT);

	/* 定义要文件选择器，所能接受的文件的后缀名称。 */
	private final static String[] suffixs = { "jpg", "bmp", "jpeg", "gif" ,"tif", "png"};
