...
public class EmfImage extends AbstractFovImage {
	...
	/**
	 * Load the original EMF data. This loads the original EMF data and reads
	 * the color space, and icc profile if any.
	 * 
	...
	public EmfImage clone()
	{
		EmfImage image = new EmfImage(this.imageInfo);
		return image;
	}
}
