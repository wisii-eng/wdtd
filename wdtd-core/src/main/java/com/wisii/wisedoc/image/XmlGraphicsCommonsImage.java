...
public abstract class XmlGraphicsCommonsImage extends AbstractFovImage {
    ...
    /**
     * @see com.wisii.wisedoc.image.AbstractFovImage#loadDimensions()
     */
    protected boolean loadDimensions() {
        if (seekableInput == null && inputStream != null) {
            ...
            try {
            	...
            	LogUtil.errorException("Error while loading image (Batik): " + ioe.getMessage(), ioe);
    ...
    /**
     * @see com.wisii.wisedoc.image.AbstractFovImage#loadBitmap()
     */
    ...
    /**
     * @see com.wisii.wisedoc.image.FovImage#hasSoftMask()
     */
    ...
    /**
     * @see com.wisii.wisedoc.image.FovImage#getSoftMask()
     */
    ...
    protected void loadImage() {
        if (loadDimensions()) {
            try {
            	...
            	LogUtil.errorException("Error while loading image (Batik): " + ex.getMessage(), ex);
            } finally {
	...
	public XmlGraphicsCommonsImage clone()
	{
		return null;
	}
}
