 ...
 * 创建日期：2008-9-18
 */
public class BackGroundImageWriter extends AbstractAttributeWriter {
    ...
    String values = getValueString(value);
	...
	returns = returns + EQUALTAG + QUOTATIONTAG + values
...
public String getValueString(Object value)
	{
		...
		{
			return XMLUtil.getXmlText((String) value);
		}
		else if(value instanceof  BindNode)
		{
			return TEXTSPLIT + DocumentWirter.getDataNodeID((BindNode)value);
		}
		return "";
}
}
