...
/**
 * 类功能描述：NumberContent Writer
 *
 * 作者：zhangqiang
 * 创建日期：2009-5-25
 */
public class NumberContentWriter extends AbstractAttributeWriter
{
	...
	{
		if (!(value instanceof NumberContent))
		{
			return "";
		}
		NumberContent numbercontent = (NumberContent) value;
		String returns = "";
		...
		returns = returns + EQUALTAG + QUOTATIONTAG + value + QUOTATIONTAG
				+ SPACETAG;
		return returns;
	}
