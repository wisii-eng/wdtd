...
public abstract class AbstractEnumAttribyteWriter extends
	...
	private void init() {
		...
		_map.put(Constants.EN_BEFORE, FoXsltConstants.BEFORE);
		_map.put(Constants.EN_AFTER, FoXsltConstants.AFTER);
		_map.put(Constants.EN_START, FoXsltConstants.START);
		_map.put(Constants.EN_END, FoXsltConstants.END);
		...
		_map.put(Constants.EN_PRESERVE, FoXsltConstants.PRESERVE);
		...
		_map.put(Constants.EN_RELATIVE, FoXsltConstants.RELATIVE);
		...
		_map.put(Constants.EN_POSITION_NUMBER_I, FoXsltConstants.POSITION_NUMBER_I);
		_map.put(Constants.EN_AUTOFONTSIZE, "autofontsize");
