 ...
 * 创建日期：2009-9-4
 */
public class ButtonGroupListAttReader extends SingleAttributeReader
{
	...
	{
		List<ButtonGroup> bglist = wsdhandler.getButtonGroupList(value);
		return bglist;
	}
