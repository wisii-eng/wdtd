 ...
 */
/**
 * @DataSourceAttributeReader.java
 * 汇智互联版权所有，未经许可，不得使用
 */
 ...
 * 创建日期：2009-9-4
 */
public class DataSourceAttributeReader extends SingleAttributeReader
{
	...
	{
		DataSource datasource = wsdhandler.getDataSource(value);
		return datasource;
	}
