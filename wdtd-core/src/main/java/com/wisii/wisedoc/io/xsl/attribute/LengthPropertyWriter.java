...
public class LengthPropertyWriter extends OutputAttributeWriter
{
	...
	public String write(Object value)
	{
		...
		{
			output = output + new FixedLengthWriter().write(value);
		} else if (value instanceof PercentLength)
		{
			output = output + new PercentLengthWriter().write(value);
		}
		return output;
	}
}
