...
/**
 * 类功能描述：NumberFormat属性writer类
 *
 * 作者：zhangqiang
 * 创建日期：2008-11-12
 */
public class NumberFormatWriter extends AbstractAttributeWriter
{
	...
	{
		if (value == null || !(value instanceof NumberFormat))
		{
			return "";
		}
		String returns = "";
		NumberFormat format = (NumberFormat) value;
		returns = returns + getKeyName(key);
		String values = "";
		values = values + format.getDecimalDigits()+" "+format.isHasthousseparator()+" "+format.isIsbaifenbi();
