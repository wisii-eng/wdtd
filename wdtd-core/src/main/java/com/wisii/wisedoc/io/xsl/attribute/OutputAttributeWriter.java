...
public class OutputAttributeWriter implements AttributeWriter,
		AttributeValueWriter
{
	public String getKeyName(int key)
	{
		return IOFactory.getAttributeIOFactory(IOFactory.XSL)
				.getAttributeKeyNameFactory().getKeyName(key);
	}
