 ...
 */
public class SinglePageMasterReferenceWriter extends AbsLayoutElementWriter
{

	SinglePageMasterReference singlePageMasterReference;

	public SinglePageMasterReferenceWriter(
			SinglePageMasterReference singlepagemasterreference)
	{
		singlePageMasterReference = singlepagemasterreference;
		WiseDocDocumentWriter.addSimP(singlePageMasterReference
				.getMasterReference());
	}
	...
	public String getAttributes()
	{
		...
		output.append(getAttribute(Constants.PR_MASTER_REFERENCE,
				singlePageMasterReference.getMasterReference().hashCode()));
	...
	{
		return FoXsltConstants.SINGLE_PAGE_MASTER_REFERENCE;
	}
