 ...
 */
public class ImageSrcWriter extends OutputAttributeWriter
{
	/*
	 * (non-Javadoc)
	 * 
	...
	{
		String attributeValue = "{$" + FoXsltConstants.SRC + "Value}";
		// 在遇到src或者background-image属性时，会生成name="srcValue"的变量
