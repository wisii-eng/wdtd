 ...
 * 创建日期：2009-9-3
 */
public class PopupBrowserInFOAttWriter extends AbstractAttributeWriter
{
	/*
	 * (non-Javadoc)
	 * 
	...
	{
		if (value == null || !(value instanceof PopupBrowserInfo))
		{
			return "";
		}
		String returns = "";
		PopupBrowserInfo popupbrowserinfo = (PopupBrowserInfo) value;
		returns = returns + getKeyName(key);
		returns = returns + EQUALTAG + QUOTATIONTAG
				+ DocumentWirter.getPopupBrowserInfoID(popupbrowserinfo) + QUOTATIONTAG
				+ SPACETAG;
		return returns;
	}
