 ...
 * 创建日期：2009-9-3
 */
public class SelectInFOAttWriter extends AbstractAttributeWriter
{
	/*
	 * (non-Javadoc)
	 * 
	...
	{
		if (value == null || !(value instanceof SelectInfo))
		{
			return "";
		}
		String returns = "";
		...
		returns = returns + EQUALTAG + QUOTATIONTAG
				+ DocumentWirter.getSelectInfoID(selectinfo) + QUOTATIONTAG
				+ SPACETAG;
		return returns;
	}
