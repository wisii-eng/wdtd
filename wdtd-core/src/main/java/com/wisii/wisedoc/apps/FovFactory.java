...
import com.wisii.wisedoc.hyphenation.HyphenationTreeResolver;
...
//	}
	 ...
	 * http://wiki.apache.org/xmlgraphics-wisedoc/IndentInheritance as is intended to improve interoperability with commercial
    ...
    public void setUserConfig(File userConfigFile)
		...
		try {
			...
			LogUtil.error("Error loading configuration: "
					+ cfge.getMessage());
		}
	}
    ...
    public void setUserConfig(Configuration userConfig) {
		...
		try {
			...
			LogUtil.error("Error initializing factory configuration: "
					+ cfge.getMessage());
		}
	}
    ...
    public void initUserConfig() throws ConfigurationException {
    	LogUtil.debug("Initializing User Agent Configuration");
		...
		if (userConfig.getChild("source-resolution", false) != null) {
			...
			LogUtil.info("Source resolution set to: " + sourceResolution
		...
		if (pageConfig.getAttribute("height", null) != null) {
			...
			LogUtil.info("Default page-height set to: " + pageHeight);
		}
		if (pageConfig.getAttribute("width", null) != null) {
			setPageWidth(pageConfig.getAttribute("width"));
			LogUtil.info("Default page-width set to: " + pageWidth);
		}
	}
    ...
    public static String getBaseURLfromConfig(Configuration cfg, String name) {
		if (cfg.getChild(name, false) != null) {
			try {
				...
				LogUtil.info(name + " set to: " + cfgBaseDir);
				return cfgBaseDir;
			} catch (MalformedURLException mue) {
				LogUtil.error("Base URL in user config is malformed!");
			}
		}
		return null;
	}
	 ...
	 * @see com.wisii.wisedoc.apps.FOURIResolver
	 */
	 ...
	 */
    /*
	 * public Fov newFov(String outputFormat) throws FOVException { return new
	 * Fov(outputFormat, newFOUserAgent()); }
	 */
 ...
 */
    /*
	 * public Fov newFov(String outputFormat, OutputStream stream) throws
	 * FOVException { return new Fov(outputFormat, newFOUserAgent(), stream); }
	 */

/**
 * Returns a new {@link Fov} instance. Use this factory method if you want to supply your
 * own {@link com.wisii.wisedoc.render.Renderer Renderer} or
 * {@link com.wisii.wisedoc.fo.FOEventHandler FOEventHandler}
