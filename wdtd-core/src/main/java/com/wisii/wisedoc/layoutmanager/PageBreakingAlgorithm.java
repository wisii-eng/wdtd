...
import com.wisii.wisedoc.layoutmanager.AbstractBreaker.PageBreakPosition;
...
class PageBreakingAlgorithm extends BreakingAlgorithm {
    ...
    public void updateData2(KnuthNode bestActiveNode,
    	...
    	LogUtil.debug("BBA> difference=" + difference + " ratio=" + ratio
    ...
    /** @see com.wisii.wisedoc.layoutmanager.BreakingAlgorithm#getLineWidth(int) */
    protected int getLineWidth(int line) {
    	...
    	LogUtil.debug("getLineWidth(" + line + ") -> " + bpd);
        return bpd;
    }
    ...
    public interface PageBreakingLayoutListener {
         ...
         */
        void notifyOverflow(int part, Element obj);
