...
public class EmptyGridUnit extends GridUnit {
    ...
    /** @see com.wisii.wisedoc.layoutmanager.table.GridUnit#isPrimary() */
    public boolean isPrimary() {
        return true;
    }

    /** @see com.wisii.wisedoc.layoutmanager.table.GridUnit#getBody() */
    public TableBody getBody() {
        return this.body;
    }

    /** @see com.wisii.wisedoc.layoutmanager.table.GridUnit#getRow() */
