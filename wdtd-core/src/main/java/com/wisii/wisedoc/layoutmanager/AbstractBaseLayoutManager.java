 ...
 * and the {@link com.wisii.wisedoc.datatypes.PercentBaseContext} interfaces
...
public abstract class AbstractBaseLayoutManager
     ...
     */
    public AbstractBaseLayoutManager(Element fo) {
        fobj = fo;
//        setGeneratesReferenceArea(fo.generatesReferenceAreas());
    ...
    public int getBaseLength(int lengthBase, Element fobj) {
        if (fobj == getFObj()) {
            ...
            default:
                LogUtil.error(new Exception("Unknown base type for LengthBase:" + lengthBase));
                return 0;
            }
        } else {
        ...
        LogUtil.error("Cannot find LM to handle given FO for LengthBase.");
        return 0;
    }
    ...
    protected int getAncestorBlockAreaIPD() {
        ...
        if (lm == null) {
        	LogUtil.error("No parent LM found");
        }
        return 0;
    }
    ...
    public int getContentAreaIPD() {
    	LogUtil.error("getContentAreaIPD called when it should have been overwritten");
        return 0;
    }
    ...
    public int getContentAreaBPD() {
    	LogUtil.error("getContentAreaBPD called when it should have been overwritten");
        return 0;
    }
    ...
    /**
     * @see com.wisii.wisedoc.layoutmanager.LayoutManager#getGeneratesLineArea
     */
    ...
    /**
     * @see com.wisii.wisedoc.layoutmanager.LayoutManager#getFObj
     */
    public Element getFObj() {
        return fobj;
    }
