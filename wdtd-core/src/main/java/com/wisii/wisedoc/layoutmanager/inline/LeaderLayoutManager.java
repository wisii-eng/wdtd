...
import com.wisii.wisedoc.area.inline.FilledArea;
...
public class LeaderLayoutManager extends LeafNodeLayoutManager {
    ...
    private InlineArea getLeaderInlineArea(LayoutContext context) {
        ...
        if (fobj.getLeaderPattern() == EN_RULE) {
            if (fobj.getRuleStyle() != EN_NONE) {
                com.wisii.wisedoc.area.inline.Leader leader
                    = new com.wisii.wisedoc.area.inline.Leader();
            ...
            leaderArea = fa;
        } else if (fobj.getLeaderPattern() == Constants.EN_USE_CONTENT) {
            if (fobj.getChildNodes() == null) {
                LogUtil.error("Leader use-content with no content");
                return null;
            }
    ...
    public void addAreas(PositionIterator posIter, LayoutContext context) {
        if (fobj.getLeaderPattern() !=Constants.EN_USE_CONTENT) {
    ...
    public LinkedList getNextKnuthElements(LayoutContext context,
        ...
        if (fobj.getLeaderPattern() == Constants.EN_USE_CONTENT && curArea instanceof FilledArea) {
