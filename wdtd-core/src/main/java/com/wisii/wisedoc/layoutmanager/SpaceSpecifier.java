...
public class SpaceSpecifier implements Cloneable {
    ...
    {
    	if(!(obj instanceof SpaceSpecifier))
    	{
    		return false;
    	}
    	SpaceSpecifier spf = (SpaceSpecifier) obj;
    	return startsReferenceArea == spf.startsReferenceArea&&hasForcing == spf.hasForcing
    	&&(spaceVals==null?spf.spaceVals==null:spaceVals.equals(spf.spaceVals));
    }
}
