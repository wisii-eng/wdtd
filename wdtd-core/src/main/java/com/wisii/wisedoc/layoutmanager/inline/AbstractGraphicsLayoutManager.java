    ...
    private Viewport getInlineArea() {
        ...
        if (cwidth > ipd || cheight > bpd) {
            ...
            if (overflow == EN_HIDDEN) {
                ...
                LogUtil.error("Object overflows the viewport: clipping");
                clip = true;
            }
        }
    	...
    	/* 【添加：START】 by 李晓光 2009-1-20 增加了层属性的处理*/
        viewportArea.addTrait(Trait.IMAGE_LAYER, fobj.getAttribute(Constants.PR_GRAPHIC_LAYER));
