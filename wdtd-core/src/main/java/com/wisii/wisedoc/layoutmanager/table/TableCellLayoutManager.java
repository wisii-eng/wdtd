...
import com.wisii.wisedoc.layoutmanager.AreaAdditionUtil;
...
public class TableCellLayoutManager extends BlockStackingLayoutManager
    ...
    public void initialize()
	{
		...
		cbpbackground = getTableCell().getCommonBorderPaddingBackground();
		borderAndPaddingBPD += cbpbackground.getBorderBeforeWidth(false);
		borderAndPaddingBPD += cbpbackground.getBorderAfterWidth(false);
		if (!isSeparateBorderModel())
		{
			borderAndPaddingBPD /= 2;
		}
		borderAndPaddingBPD += cbpbackground.getPaddingBefore(false, this);
		borderAndPaddingBPD += cbpbackground.getPaddingAfter(false, this);
	}
    ...
    public Table getTable() {
    	...
    	Element node = (Element)fobj.getParent();
    ...
    protected int getIPIndents() {
        ...
        iIndents += cbpbackground.getPaddingStart(false, this);
        iIndents += cbpbackground.getPaddingEnd(false, this);
        return iIndents;
    }
    ...
    public void addAreas(PositionIterator parentIter,
        ...
        if (isSeparateBorderModel()) {
            ...
            if (!gridUnit.hasSpanning()) {
                ...
                LogUtil.warn("TODO Add collapsed border painting for spanned cells");
            }
        }
    ...
    public Area getParentArea(Area childArea) {
        if (curBlockArea == null) {
            ...
            curBlockArea.setAreaKind(AreaKind.CELL);
            TableCell tablecell = getTableCell();
            curBlockArea.setSource(getTableCell());
            tablecell.addBlock(curBlockArea);
            ...
            indent += cbpbackground.getPaddingStart(false, this);
            // set position
            int borderAdjust = 0;
            if (!isSeparateBorderModel()) {
                if (gridUnit.hasSpanning()) {
    ...
    public int getContentAreaBPD() {
        if (curBlockArea != null) {
        	...
        	LogUtil.error("getContentAreaBPD called on unknown BPD");
            return -1;
        }
    }
