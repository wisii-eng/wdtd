...
/* $Id: Font.java 426576 2006-07-28 15:44:37Z jeremias $ */
...
public class Font {
    ...
    public char mapChar(char c) {
        ...
        if (metric instanceof com.wisii.wisedoc.fonts.Typeface) {
            return ((com.wisii.wisedoc.fonts.Typeface)metric).mapChar(c);
        }
    ...
    public boolean hasChar(char c) {
        if (metric instanceof com.wisii.wisedoc.fonts.Typeface) {
            return ((com.wisii.wisedoc.fonts.Typeface)metric).hasChar(c);
        } else {
            // Use default CodePointMapping
