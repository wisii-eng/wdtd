 ...
 */
public class ImageInline extends Inline {
	public ImageInline()
	{
		super(null);
	}
	public ImageInline(final Map<Integer,Object> attributes) {
		super(attributes);
	}

	public ImageInline(String Imagefile) {
		super(null);
		ExternalGraphic eg = new ExternalGraphic(Imagefile);
		add(eg);
	}
