...
public class WSDMReader implements Reader
{
	...
	{
		Object obj = readSource(in, WSDMKind.WSD);
	...
	private Object readSource(InputStream in, WSDMKind kind) throws IOException
	{
		Object result = null;
		if (isNull(in))
		{
	...
	private Object readSource(ZipInputStream zip, WSDMKind kind)
			throws IOException
	{
		Object result = null;
		switch (kind)
